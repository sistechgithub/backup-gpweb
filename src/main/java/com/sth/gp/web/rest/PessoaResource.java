...
public class PessoaResource {
    ...
    @Timed
    public ResponseEntity<Pessoa> create(@RequestBody Pessoa pessoa) throws URISyntaxException {
    ...
    @RequestMapping(value = "/pessoas",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<Pessoa> update(@RequestBody Pessoa pessoa) throws URISyntaxException {
    ...
    @RequestMapping(value = "/pessoas",
            ...
            produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<List<Pessoa>> getAll(@RequestParam(value = "page" , required = false) Integer offset,
                                  @RequestParam(value = "per_page", required = false) Integer limit)
        throws URISyntaxException {
        Page<Pessoa> page = pessoaRepository.findAll(PaginationUtil.generatePageRequest(offset, limit));
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/pessoas", offset, limit);
    ...
    @RequestMapping(value = "/_search/pessoas/{query}",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public List<Pessoa> search(@PathVariable String query) {
        return StreamSupport
            .stream(pessoaSearchRepository.search(queryString(query)).spliterator(), false)
